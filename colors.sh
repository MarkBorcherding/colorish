...
RESET_BOLD="${ESCAPE}[21m"
RESET_DIM="${ESCAPE}[22m"
RESET_UNDERLINE="${ESCAPE}[24m"
RESET_BLINK="${ESCAPE}[25m"
...
BG_YELLOW="${ESCAPE}[43m"      # Yellow
BG_BLUE="${ESCAPE}[44m"        # Blue
BG_PURPLE="${ESCAPE}[45m"      # Purple
...
BRIGHT_YELLOW="${ESCAPE}[0;93m"      # Yellow
BRIGHT_BLUE="${ESCAPE}[0;94m"        # Blue
BRIGHT_PURPLE="${ESCAPE}[0;95m"      # Purple
...
BG_BRIGHT_YELLOW="${ESCAPE}[0;103m"  # Yellow
BG_BRIGHT_BLUE="${ESCAPE}[0;104m"    # Blue
